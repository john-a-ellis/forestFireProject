...
#reduce size of WaterSampleData to only include the dates we are working with
# myDataFrameDict['WaterSampleData_df']['DATE_TIME_HEURE'] = pd.to_datetime(myDataFrameDict['WaterSampleData_df']['DATE_TIME_HEURE'], format = '%Y-%m-%d %H:%M')
